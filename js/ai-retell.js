(function (global) {
  ...
  function readAiSettingsForm() {
    ...
    global.state.ai.dialSettings = {
      ...
      retellAgentVersion: Math.max(1, +(global.$('aiAgentVersion')?.value || 26)),
